        ...
        <div className=" mic_card h-96 w-64 flex flex-col justify-start items-center rounded-2xl">
            ...
            <div className="w-5/6 pt-5 text-sm">
                ...
                <div className="mic_icons flex gap-4 justify-start pt-4">
                  <a href={props.whatsapp} target="_blank"><img src={whatsapp_icon} className="h-7 w-7" /></a>
                  <a href={props.instagram} target="_blank"><img src={instagram_icon} className="h-7 w-7" /></a>
                </div>
                <div className=" flex justify-center">
                <CopyToClipboard text={props.location}><button onClick={handleClick} className="mt-6 h-10 w-28 bg-green-500 text-white rounded-xl font-bold" >{click}</button></CopyToClipboard>
                </div>
            </div>
        </div>
    );
